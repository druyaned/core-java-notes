        ...
        EventQueue.invokeLater(() -> {
            for (int i = 0; i < infos.length; ++i) {
                ButtonsFrame buttonsFrame =
                    new ButtonsFrame(infos[i].getName(),
                        offset * i, offset * i);
...
class Closer extends WindowAdapter {
    ...
    public void windowClosing(WindowEvent event) {
        ...
        JPanel p = new JPanel();
        JButton y = new JButton("Close");
        JButton n = new JButton("I reconsidered");
        ...
        n.addActionListener(e -> askFrame.dispose());
