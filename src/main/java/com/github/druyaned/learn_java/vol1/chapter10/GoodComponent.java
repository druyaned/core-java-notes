...
public class GoodComponent extends JComponent {
    ...
    public void paintComponent(Graphics g) {
        ...
        StringCenterer strCenterer =
                new StringCenterer(g2, FONT, STR, centerX, centerY);
        StringCenterer labelCenterer =
                new StringCenterer(g2, LABEL_FONT, LABEL, centerX, centerY);
        labelCenterer.setXY(labelCenterer.getX(),
                            strCenterer.getY() + strCenterer.getH());
    ...
    /**
     * Usage (it isn't explicitly called):<p>
     * <code>
     * frame.getContentPane().add(component);<p>
     * frame.pack();
     * </code>
