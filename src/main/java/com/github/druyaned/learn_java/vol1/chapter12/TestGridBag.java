...
public class TestGridBag {
    ...
    public static void run() {
        ...
        EventQueue.invokeLater(() -> {
            ...
            String defaultText =
                ...
                "And this is a continuation of the text you've read more " +
                "recently.";
            int defaultFontSize = 14;
            Font defaultFont =
                new Font(Font.SANS_SERIF, Font.PLAIN, defaultFontSize);
            double k = 1D / 4;
            ...
            sizeBox.addActionListener((event) -> {
                ...
                int fontStyle = area1.getFont().getStyle();
                int fontSize = ((Integer) sizeBox.getSelectedItem()).intValue();
                area1.setFont(new Font(fontName, fontStyle, fontSize));
            });
            ...
            GBC sizeLabelGBC = new GBC(0, 1, 1, 1)
                .setAnchor(GBC.EAST).setFill(GBC.HORIZONTAL);
            GBC frameSizeButtonGBC =
                new GBC(1, 2, 1, 1)
                    .setAnchor(GBC.NORTHEAST).setFill(GBC.HORIZONTAL);
    ...
    /**
     * @param k coefficient to multiply
     *        {@link TestGridBag#WIDTH} and {@link TestGridBag#HEIGHT}
     */
    public static JTextArea makeArea(String defaultText, Font defaultFont,
        double k) {
