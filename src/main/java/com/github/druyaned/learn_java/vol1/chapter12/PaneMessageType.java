...
public class PaneMessageType extends PaneButton {
    ...
    private static Map<String, JRadioButton> buttons = new HashMap<>();
    static {
    ...
    public PaneMessageType() {
        super("Message type", buttons.get(PLAIN_MESSAGE).getModel(),
              buttons, new String[] { ERROR_MESSAGE, INFORMATION_MESSAGE,
                                      WARNING_MESSAGE, QUESTION_MESSAGE, PLAIN_MESSAGE });
    }

    public int getSelectedMessageType() {
        if (isSelected(ERROR_MESSAGE)) { return JOptionPane.ERROR_MESSAGE; }
        else if (isSelected(INFORMATION_MESSAGE)) { return JOptionPane.INFORMATION_MESSAGE; }
        else if (isSelected(WARNING_MESSAGE)) { return JOptionPane.WARNING_MESSAGE; }
        else if (isSelected(QUESTION_MESSAGE)) { return JOptionPane.QUESTION_MESSAGE; }
