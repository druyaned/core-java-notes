...
import static com.github.druyaned.learn_java.vol1.chapter14.BallImage.DIAMETER;
...
//-Getters-and-Setters------------------------------------------------------------------------------
    ...
    public final int getStepX() { return (stepX < 0) ? -stepX : stepX; }
    
    public final int getStepY() { return (stepY < 0) ? -stepY : stepY; }
