...
public class ThreadListener implements Runnable {
    ...
    public ThreadListener(BallImage circleImg, int delay, int xMin, int xMax, int yMin, int yMax) {
...
//        circleImg.setXY(x, y);
    ...
    public void setIsStopped() { this.isStopped = true; }
    
    public void unsetIsStopped() { this.isStopped = false; }
