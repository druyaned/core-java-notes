...
public class PaneConfirm extends PaneButton {
    ...
    public PaneConfirm() {
        super("Confirm pane", buttons.get(OK_CANCEL_OPTION).getModel(),
              buttons, new String[] { DEFAULT_OPTION, YES_NO_OPTION,
                                      YES_NO_CANCEL_OPTION, OK_CANCEL_OPTION });
    }

    public int getSelectedOption() {
        if (isSelected(YES_NO_OPTION)) { return JOptionPane.YES_NO_OPTION; }
        else if (isSelected(YES_NO_CANCEL_OPTION)) { return JOptionPane.YES_NO_CANCEL_OPTION; }
        else if (isSelected(OK_CANCEL_OPTION)) { return JOptionPane.OK_CANCEL_OPTION; }
        else { return JOptionPane.DEFAULT_OPTION; }
    }
}
