...
public class TestText {
    ...
    public static final Font FONT = new Font(Font.SANS_SERIF,
    ...
    public static void run() {
        ...
        EventQueue.invokeLater(() -> {
            ...
            Border etched = BorderFactory
                            .createEtchedBorder(EtchedBorder.RAISED);
            Border titledEtched = BorderFactory
                .createTitledBorder(etched, "Text area",
            ...
            ActionListener flagsListener = (event) -> {
                ...
                if (boldFlag.isSelected()) {mod += Font.BOLD;}
                if (italicFlag.isSelected()) {mod += Font.ITALIC;}
            ...
            JRadioButton smallFont = 
                new JRadioButton("Small", false);
            JRadioButton normalFont =
                new JRadioButton("Normal", false);
            JRadioButton bigFont =
                new JRadioButton("Big", false);
            ...
            int th = 4; // thickness
            Border matteBorder =
                BorderFactory.createMatteBorder(th, th, th, th, Color.GREEN);
            Border compoundBorder =
                BorderFactory.createCompoundBorder(matteBorder, lineBorder);
            southPane.setBorder(compoundBorder);
            
            JSlider slider =
                new JSlider(JSlider.HORIZONTAL, 155, 255, G_VAL);
