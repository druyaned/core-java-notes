...
public class CalcDigits extends JButton {
    ...
    public static String getText(int i) {return TEXTS[i];}
    public static String getDescription(int i) {return DESCRIPTIONS[i];}
    public static int getKeyCode(int i) {return KEY_CODES[i];}
    public static String getKeyText(int i) {return KEY_TEXTS[i];}
    public static String getMapKey(int i) {return MAP_KEYS[i];}
    public static int getMod() {return 0;}
}
