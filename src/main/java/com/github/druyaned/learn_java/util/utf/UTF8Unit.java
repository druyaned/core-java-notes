 ...
 * @see UTF16Unit
 */
public class UTF8Unit implements UTFUnit, Comparable<UTFUnit> {
...
//-Constructors-------------------------------------------------------------------------------------
     ...
     */
    public UTF8Unit(int hexCodePoint) {
...
//-Getters------------------------------------------------------------------------------------------
    ...
    /**
     * The amount of bytes of the UTF-8 representation of the Unicode code point.
     * 
     ...
     * or {@code -1} if there the amount of bytes is less than {@code 2}.
     * 
     ...
     * or {@code -1} if there the amount of bytes is less than {@code 3}.
     * 
     ...
     * or {@code -1} if there the amount of bytes is less than {@code 4}.
     * 
...
//-Methods------------------------------------------------------------------------------------------
    ...
    public String toString() {
        return String.format("[hexValue=0x%h, byte1=0x%h, byte2=0x%h, byte3=0x%h, byte4=0x%h]",
