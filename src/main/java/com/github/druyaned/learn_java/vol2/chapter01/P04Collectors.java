...
public class P04Collectors {
    ...
    public static void run() {
        ...
        // List
        List<Bro> listOfBros = Stream.of(bros).collect(ArrayList::new,
                                                       ArrayList::add,
                                                       ArrayList::addAll); // Collectors.toList()
        ...
        Map<String, Bro.Authority> mapOfBros = Stream.of(bros)
                .collect(Collectors.toMap(Bro::getPogremuha, Bro::getAuthority)); // an exception
                                                                                  // can be here
        System.out.print(blueBold("mapOfBros") + ":");
        mapOfBros.forEach((p, a) -> System.out.print(" " + p + "(" + a + ")"));
        ...
        Map<String, ArrayList<String>> countryToArrayList =
        ...
        int totalLengthOfBros = Stream.of(P03Reductions.getBros())
                .reduce(0,
        ...
        int totalLength = Stream.of(P03Reductions.getBros())
