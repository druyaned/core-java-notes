 ...
 * @author druyaned
 */
public class P03VisitorToAddGetters extends ClassVisitor {
...
//-Non-static---------------------------------------------------------------------------------------
     ...
     */
    public P03VisitorToAddGetters(Class<?> cl, ClassVisitor cv) {
    ...
    public void visitEnd() {
        for (Field field : fields) {
            ...
            if (methodDescriptor == null && (field.access & ACC_PRIVATE) == ACC_PRIVATE) {
                methodDescriptor = getMethodDescriptor(getType(fieldDescriptor));
                MethodVisitor mv = cv.visitMethod(ACC_PUBLIC, methodName, methodDescriptor,
                                                  null, null);
                mv.visitCode();
