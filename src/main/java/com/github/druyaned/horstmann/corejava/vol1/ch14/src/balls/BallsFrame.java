package com.github.druyaned.horstmann.corejava.vol1.ch14.src.balls;

import com.github.druyaned.horstmann.corejava.vol1.ch14.src.ball.BallPosition;
import com.github.druyaned.horstmann.corejava.vol1.ch14.src.ball.BallFrame;
import static com.github.druyaned.horstmann.corejava.vol1.ch14.src.ball.BallPosition.DEFAULT_STEP;
import java.awt.*;
import javax.swing.*;
...
public class BallsFrame extends JFrame {
    ...
    public BallsFrame() {
        ...
        BallsButtonPane buttonsPane = new BallsButtonPane(
                addBall, pause,
                stepXSlider, stepYSlider
        );
