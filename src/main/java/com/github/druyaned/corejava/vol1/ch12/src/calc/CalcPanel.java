...
import javax.swing.*;
import static com.github.druyaned.corejava.vol1.ch12.src.calc.CalcCommand.*;
...
//-Static-------------------------------------------------------------------------------------------
    ...
    public static final int LOCAL_HEIGHT;
    ...
    static {
        ...
        LOCAL_WIDTH = (int)(d.getWidth() / SCREEN_PART);
        LOCAL_HEIGHT = (int)(LOCAL_WIDTH * HEIGHT_WIDTH_RATIO);
        X = (int)(d.getWidth() / 2) - LOCAL_WIDTH / 2;
        Y = (int)(d.getHeight() / 2) - LOCAL_HEIGHT / 2;
        DISPLAY_FONT_SIZE = LOCAL_WIDTH / 16;
        BUTTON_FONT_SIZE = LOCAL_WIDTH / 16;
...
//-Non-static---------------------------------------------------------------------------------------
    ...
    private final AllYouNeed allYouNeed;
    ...
    private void setIsDotUsed(int isDotUsed) {this.isDotUsed = (isDotUsed == 1);}
    ...
    @Override public Dimension getPreferredSize() {
        return new Dimension(LOCAL_WIDTH, LOCAL_HEIGHT);
    }
