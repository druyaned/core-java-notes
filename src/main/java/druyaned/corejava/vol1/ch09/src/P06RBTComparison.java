...
import druyaned.corejava.vol1.ch09.src.rbt.RBT;
import druyaned.corejava.vol1.ch09.src.rbt.RBTIndexed;
import java.util.ArrayList;
import java.util.Random;
import java.util.TreeSet;

public class P06RBTComparison implements Runnable {
    ...
    private static long additionTest(TreeSet<Integer> tree, int[] arr) {
    ...
    private static long additionTest(RBT<Integer> tree, int[] arr) {
        long start = System.currentTimeMillis();
        for (int num : arr)
            tree.add(num);
        long stop = System.currentTimeMillis();
    ...
    private static long additionTest(RBTIndexed tree, int[] arr) {
        long start = System.currentTimeMillis();
        for (int num : arr)
            tree.add(num);
        long stop = System.currentTimeMillis();
    ...
    private static long removalTest(TreeSet<Integer> tree, int[] arr) {
        long start = System.currentTimeMillis();
        for (int num : arr)
            tree.remove(num);
        long stop = System.currentTimeMillis();
    ...
    private static long removalTest(RBT<Integer> tree, int[] arr) {
        long start = System.currentTimeMillis();
        for (int num : arr)
            tree.remove(num);
        long stop = System.currentTimeMillis();
    ...
    private static long removalTest(RBTIndexed tree, int[] arr) {
        long start = System.currentTimeMillis();
        for (int num : arr)
            tree.remove(num);
        long stop = System.currentTimeMillis();
