...
public class T03Lambda extends Topic {
    
    public T03Lambda(Chapter chapter) {
        super(chapter, 3);
    }
    ...
    private static void methodLinks() {
        System.out.println("\nmethodLinks:");
