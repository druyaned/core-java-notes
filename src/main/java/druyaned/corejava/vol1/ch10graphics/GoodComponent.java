...
public class GoodComponent extends JComponent {
    ...
    @Override protected void paintComponent(Graphics g) {
        ...
        StringCenterer strCenterer = new StringCenterer(g2, FONT, STR, centerX, centerY);
        StringCenterer labelCenterer = new StringCenterer(g2, LABEL_FONT, LABEL, centerX, centerY);
        ...
        final Point2D D = new Point2D.Double(strCenterer.getX() + strCenterer.getW(), centerY);
