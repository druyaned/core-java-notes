...
import druyaned.corejava.vol1.ch14concurrency.t01bounce.Ball;
import druyaned.corejava.vol1.ch14concurrency.t01bounce.BallPanel;
...
public class T01Bounce extends Topic {
    
    public T01Bounce(Chapter chapter) {
        super(chapter, 1);
    }
    
    @Override public String title() {
        return "Topic 01 Bounce";
    }
    ...
    private void bounce(BallPanel ballPanel) {
