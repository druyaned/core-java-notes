...
/**
 * PrinterHeapInt of the {@link Heap}.
 * @author druyaned
 */
public class PrinterHeapInt extends AbstractPrinter<HeapInt> {
    
    public PrinterHeapInt(HeapInt target, String filler, PrintStream sout) {
