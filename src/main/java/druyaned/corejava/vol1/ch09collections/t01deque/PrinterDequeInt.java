package druyaned.corejava.vol1.ch09collections.t01deque;

import druyaned.corejava.vol1.ch09collections.util.AbstractPrinter;
import java.io.PrintStream;

public class PrinterDequeInt extends AbstractPrinter<DequeInt> {
    
    public PrinterDequeInt(DequeInt target, String filler, PrintStream sout) {
    ...
    @Override public void print() {
        ...
        for (int i = 1; i < target.capacity(); i++) {
    ...
    private void printValue(int index, int maxValLen) {
        ...
        if (
                maxValLen % 2 == 1 && valLen % 2 == 0
                || maxValLen % 2 == 0 && valLen % 2 == 1
        )
            leftIndent += filler;
