 ...
 * @author druyaned
 */
public class C07ExceptionsLogging extends Chapter {
    
    /**
     * Creates the Chapter#07: Exceptions, Assertions, and Logging.
     * @param volume to which the chapter belongs
     */
    public C07ExceptionsLogging(Volume volume) {
        super(volume, 7);
        topics().add(new T01StackTrace(this));
        topics().add(new T02TryCatchTime(this));
        topics().add(new T03Assertions(this));
        topics().add(new T04Log(this));
    }
    
    @Override public String title() {
        return "Chapter 07 Exceptions, Assertions, and Logging";
    }
